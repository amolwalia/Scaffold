...
export default function GrantDetailsScreen() {
  ...
  const grantData = {
    ...
    eligible: true,
    description:
      "The Trades Training Fund is an opportunity primarily for residents of Northwest BC. If the applicant has an employment attachment, the employer must have a business operating in Northwest BC, except for the two designated trades that are ...",
    fullDescription:
      "The Trades Training Fund is an opportunity primarily for residents of Northwest BC. If the applicant has an employment attachment, the employer must have a business operating in Northwest BC, except for the two designated trades that are eligible for funding throughout BC. This fund supports individuals pursuing trades training and certification in various construction and industrial trades.",
  };
          ...
          <View className="bg-gray-100 rounded-2xl p-4 flex-1 mr-2 items-center">
            <View className="w-8 h-8 items-center justify-center mb-2">
              ...
              >
                ...
                <path
                  d="M6.66304 12.5232L11.3315 16.4346L19.0437 8.10513"
                  stroke="white"
